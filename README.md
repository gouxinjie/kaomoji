...
一个纯静态的中文表达符号收藏网站，收录 **颜文字、Emoji 图标、特殊符号、汉字部首、花字变体、装饰长串** 六大类内容，总计 **120+ 个分类、约 1800+ 个精选条目**。点击即可一键复制到剪贴板，让文字表达更有温度。
...
- **六大内容板块**：顶部 Tab 一键切换
  ...
  - ⓐ **花字变体**：12 大类、283 个带圈/带框/花体/全角等 Unicode 变体字母数字，昵称签名一步到位
  - ✦ **装饰长串**：9 大类、120 个花式分隔线、长串星星爱心、文字点缀，文章排版评论区都能用
